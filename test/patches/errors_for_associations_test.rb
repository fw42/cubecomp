...
class ErrorsForAssociationsTest < ActionController::TestCase
  ...
  test "error on association is also set on the _id field" do
    ...
    label_error = %q{div class="field_with_errors"><label for="competitor_country">Country:</label></div>}
    select_error = %q{<div class="field_with_errors"><select id="competitor_country_id"}
